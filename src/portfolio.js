...
const blogSection = {
  title: "Blogs",
  subtitle:
    "With Love for solving problems, I love to write about the problems I have come across and document the process of how I am attempting to solve them.",
  displayMediumBlogs: "true", // Set true to display fetched medium blogs instead of hardcoded ones
  blogs: [
    {
      url: "https://medium.com/@avashesh.work/engineering-a-smart-scheduling-algorithm-for-450-cricket-matches-amidst-myriad-constraints-part-66c653250ff4",
      title: "Engineering a Smart Scheduling Algorithm for 450+ Cricket Matches (Part 1)",
      description:
